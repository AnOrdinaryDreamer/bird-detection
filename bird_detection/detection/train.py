# cобирает все DataLoader по конфигу, собирает все параметры обучения из конфига, набор аугментаций, модель для использования из конфига, и запускает основной train loop
